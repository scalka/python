...
# Load user ratings
raw_dataset_df = pd.read_csv('../recipe_ratings_data_set.csv')

# Convert the running list of user ratings into a matrix
ratings_df = pd.pivot_table(raw_dataset_df, index='user_id', columns='recipe_id', aggfunc=np.max)
...
predicted_ratings_df.to_csv("recipes_predicted_ratings.csv")
